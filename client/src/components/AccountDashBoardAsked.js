...
const AccountDashboardAsked = ({ accountAskedData, isAskLoaded, modalDispatch }) => {
  return (
    <div className="row-start-2 row-end-4 lg:row-start-1 lg:row-end-4 lg:min-h-[400px] max-h-[500px] col-start-1 -ml-5 sm:-ml-0 w-screen sm:w-full sm:col-start-2 col-end-8 lg:col-end-5 bg-slate-400 rounded-sm overflow-scroll">
