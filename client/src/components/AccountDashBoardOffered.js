...
const AccountDashboardOffered = ({ accountItemsData, isItemsLoaded, modalDispatch,errorPlaceholder }) => {  
  return (
    <div className="row-start-4 row-end-6 md:h-fit -ml-5 sm:-ml-0 w-screen sm:w-full lg:row-start-1 lg:row-end-4 min-h-[500px] max-h-[500px] col-start-1 sm:col-start-2 lg:col-start-5 col-end-8 bg-slate-400 overflow-scroll">
