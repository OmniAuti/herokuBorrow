...
const ModalEditAsk = ({data,handleItemRefreshAfterEdit,handleOpenModal, user}) => {
...
return (<form
      ...
      >
        <label htmlFor="who " className=" text-black">I am a . . .</label>
        <select
        ...
        <label htmlFor="type" className=" text-black">In need of a . . .</label>
        <select
          value={askObj.type}
          id="type"
...
<p className=" text-black">Current Condition: {data.condition}</p>
        <label htmlFor="condition" className=" text-black">Acceptable Condition</label>
        <div className="flex flex-wrap items-center justify-around">
          {checkBoxArr.map((checkbox) => {
            return (
              <div className="" key={checkbox.id}>
                <label className="text-black" htmlFor={checkbox.value}>{checkbox.value}</label>
                <input
